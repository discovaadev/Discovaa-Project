...
import BspBookingConfirmedModal from "../components/BspBookingConfirmedModal";

const BspAvailability = ({ onClose }) => {
...
export default BspAvailability;
