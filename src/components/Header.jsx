...
export default function Header({
  ...
  if (location.pathname !== "/ispprofilepage" && location.pathname !== "/bspprofilepage" && location.pathname !== "/ispprofilepageedit") {
      return;
    }
      ...
      <div className="flex items-center space-x-6">
        {showIcons && (
          <div className="flex space-x-3 text-lg mr-8">
            ...
            <Link
              to={userType === "individualServiceProvider" || userType === "businessServiceProvider" ? "#" : getFavoritesRoute()}
              title="Favorites"
