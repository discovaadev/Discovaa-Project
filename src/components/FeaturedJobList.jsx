...
export default function FeaturedJobList() {
  return (
    <section className="w-[97%] h-[700px] border border-gray-300 rounded-[70px] mx-auto mt-[280px] flex flex-col items-center hidden md:block">
      <div className="flex bg-black relative justify-between items-center m-auto h-[270px] rounded-[25px] mt-[-100px] md:w-[500px] lg:flex lg:w-[1020px]">
        <div className="mt-[-75px] ml-[60px]">
          <img src={CardImg} alt="card-img" className="w-[365px] md:hidden lg:block" />
        </div>
      ...
      <div className="font-inter text-center font-semibold text-3xl mt-[40px]">
      ...
      <div className="flex justify-center mt-[50px]">
        ...
        <img src={Image4} alt="Image 4" className="w-[219px] h-[210px] mx-[10px] md:hidden lg:block" />
      </div>
    </section>
  );
}
