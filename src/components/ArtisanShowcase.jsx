...
function ReviewsCard() {
  return (
    <div className=" hidden md:h-32 bg-[#fff9f5] lg:bg-[#fff9f5] lg:h-[422px] ">
      <div className="flex justify-between px-[150px] py-[105px] ">
        ...
        <div className="" >
          ...
          <div className="relative flex items-center mt-5 md:-translate-y-20 translate-x-52 lg:flex lg:translate-x-0 lg:translate-y-0 ">
            <div className="absolute w-[90%] h-full right-[34px] bg-[#fff9f5] shadow"></div>
            <div className="flex items-center gap-3 relative left-[18px] -translate-x-6">
              <img src={EmailFrame} alt="Email Icon" className="w-6 h-6 ml-2" />
