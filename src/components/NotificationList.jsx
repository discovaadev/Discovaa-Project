        ...
        <>
          <div className="mb-6">
            ...
            {latestNotifications.map((notification, index) => (
              <NotificationItem
                key={index}
                {...notification}
                isRead={notification.section === "New Message" ? notification.isRead : false}
                isLatest={true}
                isConfirmBooking={notification.section === "Confirmed Booking"}
              />
            ))}
          ...
          <div>
            ...
            {previousNotifications.map((notification, index) => (
              <NotificationItem key={index} {...notification} isConfirmBooking={notification.section === "Confirmed Booking"}/>
            ))}
